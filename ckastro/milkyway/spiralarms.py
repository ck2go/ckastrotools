...
def getSpiralArmXY(spiral_name, beta_min=-110, beta_max=270., model='reid2014', resolution=0.0001, R_0=8.34):
...
def getSpiralArms():
    sy, sx, svy1, svx1, svy2, svx2, scy, scx, scvy, scvx, scvy2, scvx2, oy, ox, ovy, ovx, ocky, ockx, py, px, pvy, pvx, pvy2, pvx2, pcky, pckx = getSpiralArmsDetail()
